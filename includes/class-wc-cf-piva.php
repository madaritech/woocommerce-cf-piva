...
class Wc_Cf_Piva
{
     ...
     *
     * - Wc_Cf_Piva_Loader. Orchestrates the hooks of the plugin.
     * - Wc_Cf_Piva_i18n. Defines internationalization functionality.
     * - Wc_Cf_Piva_Admin. Defines all hooks for the admin area.
     * - Wc_Cf_Piva_Public. Defines all hooks for the public side of the site.
     *
    ...
    private function load_dependencies()
    {
         ...
         * side of the site.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'public/class-wc-cf-piva-public.php';

        $this->loader = new Wc_Cf_Piva_Loader();
    }

    /**
     * Define the locale for this plugin for internationalization.
     *
     * Uses the Wc_Cf_Piva_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
    ...
    {
        $plugin_i18n = new Wc_Cf_Piva_i18n();
     ...
     *
     * @since     1.0.0
     * @return    Wc_Cf_Piva_Loader    Orchestrates the hooks of the plugin.
     */
