...
class Mdt_Wc_Easy_Cf_Piva_Admin
{
    ...
    */
    ...
    public function mdt_wc_easy_cf_piva_settings_init()
    {
        ...
        foreach ($placeholder as $setting_key => $plc_value) {
            ...
            add_settings_field(
                ...
                'mdt_wc_easy_cf_piva_settings_page',
                'mdt_wc_easy_cf_piva_settings_section',
                ['value' => $value,'key' => $setting_key,'desc' => $description[$setting_key], 'placeholder' => $plc_value]
            );
        }
    }
     ...
     *
     * @param $options_array array The array of options to sanitize.
     * @since 1.0.1
     */
    ...
    {
        echo "<p>".__('Se si desidera modificare i valori di default delle etichette per ciascun campo, utilizzare i campi qui sotto riportati', 'mdt_wc_easy_cf_piva').":</p>";
    }

    /**
     * The Admin Setting Field Callback.
     *
     * @param string $args array() Parameters defined in the add_settings_field function call
     * @since 1.0.1
     */
    ...
    <input type="text" name="mdt_wc_easy_cf_piva_options[<?php echo $args['key']; ?>]" placeholder="<?php echo $args['placeholder']; ?>" value= "<?php echo $args['value']; ?>" class="regular-text" /><span class="description"><?php echo $args['desc']; ?></span><br></br>
